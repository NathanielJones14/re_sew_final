...
import 'package:re_sew/UI/Filters/Categories/Clothing_detail_page.dart';
    ...
    return new Scaffold(
        ...
        body: ListView.builder(
          itemBuilder: (context, index) =>
              new ClothingProjectCard(clothingList[index]),
          itemCount: clothingList.length,
        ));
  }
}

class ClothingProjectCard extends StatelessWidget {
  final Clothing clothingList;

  ClothingProjectCard(this.clothingList);
    ...
    final projectCardContent = new Container(
      ...
      child: new Column(
        ...
        children: <Widget>[
          ...
          new Text(clothingList.difficulty, style: Style.commonTextStyle),
          new Container(height: 10.0),
          new Text(clothingList.material, style: Style.commonTextStyle),
          new Container(height: 10.0),
          new Text(clothingList.time, style: Style.commonTextStyle),
        ],
      ),
    );
    ...
    final projectCard = new Container(
      ...
      decoration: new BoxDecoration(
        image: new DecorationImage(
          image: new AssetImage(clothingList.image),
          fit: BoxFit.fitWidth,
        ),
        ...
        onTap: () {
          Navigator.of(context).push(
            MaterialPageRoute(builder: (context) {
              return ClothingDetailPage(clothingList);
            }),
          );
        },
        child: Container(
